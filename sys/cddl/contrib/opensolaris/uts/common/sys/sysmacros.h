...
{
#if defined(__NQC__) && defined(__FreeBSD__) && defined(_KERNEL) && defined(HAVE_INLINE_FLSL)
	return (flsl(i));
#else
	int h = 1;
...
{
#if defined(__NQC__) && defined(__FreeBSD__) && defined(_KERNEL) && defined(HAVE_INLINE_FLSLL)
	return (flsll(i));
#else
	int h = 1;
