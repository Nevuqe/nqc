...
const char *syscallnames[] = {
	...
	"chown",			/* 16 = chown */
	"break",			/* 17 = break */
	"compat4.getfsstat",		/* 18 = nqc4 getfsstat */
	...
	"compat4.statfs",		/* 157 = nqc4 statfs */
	"compat4.fstatfs",		/* 158 = nqc4 fstatfs */
	...
	"compat6.pread",		/* 173 = nqc6 pread */
	"compat6.pwrite",		/* 174 = nqc6 pwrite */
	"setfib",			/* 175 = setfib */
	...
	"compat11.stat",		/* 188 = nqc11 stat */
	"compat11.fstat",		/* 189 = nqc11 fstat */
	"compat11.lstat",		/* 190 = nqc11 lstat */
	"pathconf",			/* 191 = pathconf */
	"fpathconf",			/* 192 = fpathconf */
	"#193",			/* 193 = reserved for local use */
	"getrlimit",			/* 194 = getrlimit */
	"setrlimit",			/* 195 = setrlimit */
	"compat11.getdirentries",		/* 196 = nqc11 getdirentries */
	"compat6.mmap",		/* 197 = nqc6 mmap */
	"__syscall",			/* 198 = __syscall */
	"compat6.lseek",		/* 199 = nqc6 lseek */
	"compat6.truncate",		/* 200 = nqc6 truncate */
	"compat6.ftruncate",		/* 201 = nqc6 ftruncate */
	...
	"compat7.__semctl",		/* 220 = nqc7 __semctl */
	"semget",			/* 221 = semget */
	"semop",			/* 222 = semop */
	"obs_semconfig",			/* 223 = obsolete semconfig */
	"compat7.msgctl",		/* 224 = nqc7 msgctl */
	"msgget",			/* 225 = msgget */
	"msgsnd",			/* 226 = msgsnd */
	"msgrcv",			/* 227 = msgrcv */
	"shmat",			/* 228 = shmat */
	"compat7.shmctl",		/* 229 = nqc7 shmctl */
	"shmdt",			/* 230 = shmdt */
	"shmget",			/* 231 = shmget */
	...
	"compat11.nstat",		/* 278 = nqc11 nstat */
	"compat11.nfstat",		/* 279 = nqc11 nfstat */
	"compat11.nlstat",		/* 280 = nqc11 nlstat */
	...
	"compat4.fhstatfs",		/* 297 = nqc4 fhstatfs */
	"fhopen",			/* 298 = fhopen */
	"compat11.fhstat",		/* 299 = nqc11 fhstat */
	"modnext",			/* 300 = modnext */
	"modstat",			/* 301 = modstat */
	...
	"compat6.aio_read",		/* 318 = nqc6 aio_read */
	"compat6.aio_write",		/* 319 = nqc6 aio_write */
	"compat6.lio_listio",		/* 320 = nqc6 lio_listio */
	"yield",			/* 321 = yield */
	...
	"kqueue",			/* 362 = kqueue */
	"compat11.kevent",		/* 363 = nqc11 kevent */
	...
	"compat11.getfsstat",		/* 395 = nqc11 getfsstat */
	...
	"compat10._umtx_lock",		/* 434 = nqc10 _umtx_lock */
	"compat10._umtx_unlock",		/* 435 = nqc10 _umtx_unlock */
	...
	"fexecve",			/* 492 = fexecve */
	"compat11.fstatat",		/* 493 = nqc11 fstatat */
