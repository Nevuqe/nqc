...
#ifdef COMPAT_NQC4
#define compat4(n, name) .sy_narg = n, .sy_call = (sy_call_t *)__CONCAT(nqc4_, name)
#else
#define compat4(n, name) .sy_narg = 0, .sy_call = (sy_call_t *)nosys
#endif

#ifdef COMPAT_NQC6
#define compat6(n, name) .sy_narg = n, .sy_call = (sy_call_t *)__CONCAT(nqc6_, name)
#else
#define compat6(n, name) .sy_narg = 0, .sy_call = (sy_call_t *)nosys
#endif

#ifdef COMPAT_NQC7
#define compat7(n, name) .sy_narg = n, .sy_call = (sy_call_t *)__CONCAT(nqc7_, name)
#else
#define compat7(n, name) .sy_narg = 0, .sy_call = (sy_call_t *)nosys
#endif

#ifdef COMPAT_NQC10
#define compat10(n, name) .sy_narg = n, .sy_call = (sy_call_t *)__CONCAT(nqc10_, name)
#else
#define compat10(n, name) .sy_narg = 0, .sy_call = (sy_call_t *)nosys
#endif

#ifdef COMPAT_NQC11
#define compat11(n, name) .sy_narg = n, .sy_call = (sy_call_t *)__CONCAT(nqc11_, name)
#else
#define compat11(n, name) .sy_narg = 0, .sy_call = (sy_call_t *)nosys
#endif

#ifdef COMPAT_NQC12
#define compat12(n, name) .sy_narg = n, .sy_call = (sy_call_t *)__CONCAT(nqc12_, name)
#else
#define compat12(n, name) .sy_narg = 0, .sy_call = (sy_call_t *)nosys
#endif

#ifdef COMPAT_NQC13
#define compat13(n, name) .sy_narg = n, .sy_call = (sy_call_t *)__CONCAT(nqc13_, name)
#else
#define compat13(n, name) .sy_narg = 0, .sy_call = (sy_call_t *)nosys
#endif

/* The casts are bogus but will do for now. */
struct sysent nqc32_sysent[] = {
	...
	{ .sy_narg = AS(nqc32_wait4_args), .sy_call = (sy_call_t *)nqc32_wait4, .sy_auevent = AUE_WAIT4, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 7 = nqc32_wait4 */
	...
	{ compat11(AS(nqc11_mknod_args),mknod), .sy_auevent = AUE_MKNOD, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 14 = nqc11 mknod */
	...
	{ compat4(AS(nqc4_nqc32_getfsstat_args),nqc32_getfsstat), .sy_auevent = AUE_GETFSSTAT, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 18 = nqc4 nqc32_getfsstat */
	{ compat(AS(onqc32_lseek_args),nqc32_lseek), .sy_auevent = AUE_LSEEK, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 19 = old nqc32_lseek */
	...
	{ .sy_narg = AS(nqc32_ptrace_args), .sy_call = (sy_call_t *)nqc32_ptrace, .sy_auevent = AUE_PTRACE, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 26 = nqc32_ptrace */
	{ .sy_narg = AS(nqc32_recvmsg_args), .sy_call = (sy_call_t *)nqc32_recvmsg, .sy_auevent = AUE_RECVMSG, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 27 = nqc32_recvmsg */
	{ .sy_narg = AS(nqc32_sendmsg_args), .sy_call = (sy_call_t *)nqc32_sendmsg, .sy_auevent = AUE_SENDMSG, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 28 = nqc32_sendmsg */
	...
	{ compat(AS(onqc32_stat_args),nqc32_stat), .sy_auevent = AUE_STAT, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 38 = old nqc32_stat */
	...
	{ compat(AS(onqc32_lstat_args),nqc32_lstat), .sy_auevent = AUE_LSTAT, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 40 = old nqc32_lstat */
	{ .sy_narg = AS(dup_args), .sy_call = (sy_call_t *)sys_dup, .sy_auevent = AUE_DUP, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 41 = dup */
	{ compat10(0,pipe), .sy_auevent = AUE_PIPE, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 42 = nqc10 pipe */
	...
	{ compat(AS(onqc32_sigaction_args),nqc32_sigaction), .sy_auevent = AUE_SIGACTION, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 46 = old nqc32_sigaction */
	...
	{ .sy_narg = AS(nqc32_sigaltstack_args), .sy_call = (sy_call_t *)nqc32_sigaltstack, .sy_auevent = AUE_SIGALTSTACK, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 53 = nqc32_sigaltstack */
	{ .sy_narg = AS(nqc32_ioctl_args), .sy_call = (sy_call_t *)nqc32_ioctl, .sy_auevent = AUE_IOCTL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 54 = nqc32_ioctl */
	...
	{ .sy_narg = AS(nqc32_execve_args), .sy_call = (sy_call_t *)nqc32_execve, .sy_auevent = AUE_EXECVE, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 59 = nqc32_execve */
	...
	{ compat(AS(onqc32_fstat_args),nqc32_fstat), .sy_auevent = AUE_FSTAT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 62 = old nqc32_fstat */
	...
	{ compat(AS(onqc32_mmap_args),nqc32_mmap), .sy_auevent = AUE_MMAP, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 71 = old nqc32_mmap */
	{ compat11(AS(nqc11_vadvise_args),vadvise), .sy_auevent = AUE_O_VADVISE, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 72 = nqc11 vadvise */
	...
	{ .sy_narg = AS(nqc32_mprotect_args), .sy_call = (sy_call_t *)nqc32_mprotect, .sy_auevent = AUE_MPROTECT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 74 = nqc32_mprotect */
	...
	{ .sy_narg = AS(nqc32_setitimer_args), .sy_call = (sy_call_t *)nqc32_setitimer, .sy_auevent = AUE_SETITIMER, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 83 = nqc32_setitimer */
	...
	{ .sy_narg = AS(nqc32_getitimer_args), .sy_call = (sy_call_t *)nqc32_getitimer, .sy_auevent = AUE_GETITIMER, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 86 = nqc32_getitimer */
	...
	{ .sy_narg = AS(nqc32_fcntl_args), .sy_call = (sy_call_t *)nqc32_fcntl, .sy_auevent = AUE_FCNTL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 92 = nqc32_fcntl */
	{ .sy_narg = AS(nqc32_select_args), .sy_call = (sy_call_t *)nqc32_select, .sy_auevent = AUE_SELECT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 93 = nqc32_select */
	...
	{ compat(AS(onqc32_sigreturn_args),nqc32_sigreturn), .sy_auevent = AUE_SIGRETURN, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 103 = old nqc32_sigreturn */
	...
	{ compat(AS(onqc32_sigvec_args),nqc32_sigvec), .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 108 = old nqc32_sigvec */
	...
	{ compat(AS(onqc32_sigstack_args),nqc32_sigstack), .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 112 = old nqc32_sigstack */
	{ compat(AS(onqc32_recvmsg_args),nqc32_recvmsg), .sy_auevent = AUE_RECVMSG, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 113 = old nqc32_recvmsg */
	{ compat(AS(onqc32_sendmsg_args),nqc32_sendmsg), .sy_auevent = AUE_SENDMSG, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 114 = old nqc32_sendmsg */
	{ .sy_narg = 0, .sy_call = (sy_call_t *)nosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },			/* 115 = obsolete vtrace */
	{ .sy_narg = AS(nqc32_gettimeofday_args), .sy_call = (sy_call_t *)nqc32_gettimeofday, .sy_auevent = AUE_GETTIMEOFDAY, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 116 = nqc32_gettimeofday */
	{ .sy_narg = AS(nqc32_getrusage_args), .sy_call = (sy_call_t *)nqc32_getrusage, .sy_auevent = AUE_GETRUSAGE, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 117 = nqc32_getrusage */
	...
	{ .sy_narg = AS(nqc32_readv_args), .sy_call = (sy_call_t *)nqc32_readv, .sy_auevent = AUE_READV, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 120 = nqc32_readv */
	{ .sy_narg = AS(nqc32_writev_args), .sy_call = (sy_call_t *)nqc32_writev, .sy_auevent = AUE_WRITEV, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 121 = nqc32_writev */
	{ .sy_narg = AS(nqc32_settimeofday_args), .sy_call = (sy_call_t *)nqc32_settimeofday, .sy_auevent = AUE_SETTIMEOFDAY, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 122 = nqc32_settimeofday */
	...
	{ compat(AS(onqc32_truncate_args),nqc32_truncate), .sy_auevent = AUE_TRUNCATE, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 129 = old nqc32_truncate */
	{ compat(AS(onqc32_ftruncate_args),nqc32_ftruncate), .sy_auevent = AUE_FTRUNCATE, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 130 = old nqc32_ftruncate */
	...
	{ .sy_narg = AS(nqc32_utimes_args), .sy_call = (sy_call_t *)nqc32_utimes, .sy_auevent = AUE_UTIMES, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 138 = nqc32_utimes */
	{ .sy_narg = 0, .sy_call = (sy_call_t *)nosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },			/* 139 = obsolete 4.2 sigreturn */
	{ .sy_narg = AS(nqc32_adjtime_args), .sy_call = (sy_call_t *)nqc32_adjtime, .sy_auevent = AUE_ADJTIME, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 140 = nqc32_adjtime */
	...
	{ compat(AS(onqc32_sethostid_args),nqc32_sethostid), .sy_auevent = AUE_SYSCTL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 143 = old nqc32_sethostid */
	...
	{ compat(AS(onqc32_getdirentries_args),nqc32_getdirentries), .sy_auevent = AUE_GETDIRENTRIES, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 156 = old nqc32_getdirentries */
	{ compat4(AS(nqc4_nqc32_statfs_args),nqc32_statfs), .sy_auevent = AUE_STATFS, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 157 = nqc4 nqc32_statfs */
	{ compat4(AS(nqc4_nqc32_fstatfs_args),nqc32_fstatfs), .sy_auevent = AUE_FSTATFS, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 158 = nqc4 nqc32_fstatfs */
	...
	{ compat4(AS(nqc4_getdomainname_args),getdomainname), .sy_auevent = AUE_SYSCTL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 162 = nqc4 getdomainname */
	{ compat4(AS(nqc4_setdomainname_args),setdomainname), .sy_auevent = AUE_SYSCTL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 163 = nqc4 setdomainname */
	{ compat4(AS(nqc4_uname_args),uname), .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 164 = nqc4 uname */
	{ .sy_narg = AS(nqc32_sysarch_args), .sy_call = (sy_call_t *)nqc32_sysarch, .sy_auevent = AUE_SYSARCH, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 165 = nqc32_sysarch */
	...
	{ .sy_narg = AS(nqc32_semsys_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 169 = nqc32_semsys */
	{ .sy_narg = AS(nqc32_msgsys_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 170 = nqc32_msgsys */
	{ .sy_narg = AS(nqc32_shmsys_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 171 = nqc32_shmsys */
	{ .sy_narg = 0, .sy_call = (sy_call_t *)nosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },			/* 172 = reserved for local use */
	{ compat6(AS(nqc6_nqc32_pread_args),nqc32_pread), .sy_auevent = AUE_PREAD, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 173 = nqc6 nqc32_pread */
	{ compat6(AS(nqc6_nqc32_pwrite_args),nqc32_pwrite), .sy_auevent = AUE_PWRITE, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 174 = nqc6 nqc32_pwrite */
	{ .sy_narg = AS(setfib_args), .sy_call = (sy_call_t *)sys_setfib, .sy_auevent = AUE_SETFIB, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 175 = setfib */
	{ .sy_narg = AS(nqc32_ntp_adjtime_args), .sy_call = (sy_call_t *)nqc32_ntp_adjtime, .sy_auevent = AUE_NTP_ADJTIME, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 176 = nqc32_ntp_adjtime */
	...
	{ compat11(AS(nqc11_nqc32_stat_args),nqc32_stat), .sy_auevent = AUE_STAT, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 188 = nqc11 nqc32_stat */
	{ compat11(AS(nqc11_nqc32_fstat_args),nqc32_fstat), .sy_auevent = AUE_FSTAT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 189 = nqc11 nqc32_fstat */
	{ compat11(AS(nqc11_nqc32_lstat_args),nqc32_lstat), .sy_auevent = AUE_LSTAT, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 190 = nqc11 nqc32_lstat */
	...
	{ compat11(AS(nqc11_nqc32_getdirentries_args),nqc32_getdirentries), .sy_auevent = AUE_GETDIRENTRIES, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 196 = nqc11 nqc32_getdirentries */
	{ compat6(AS(nqc6_nqc32_mmap_args),nqc32_mmap), .sy_auevent = AUE_MMAP, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 197 = nqc6 nqc32_mmap */
	{ .sy_narg = 0, .sy_call = (sy_call_t *)nosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },		/* 198 = __syscall */
	{ compat6(AS(nqc6_nqc32_lseek_args),nqc32_lseek), .sy_auevent = AUE_LSEEK, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 199 = nqc6 nqc32_lseek */
	{ compat6(AS(nqc6_nqc32_truncate_args),nqc32_truncate), .sy_auevent = AUE_TRUNCATE, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 200 = nqc6 nqc32_truncate */
	{ compat6(AS(nqc6_nqc32_ftruncate_args),nqc32_ftruncate), .sy_auevent = AUE_FTRUNCATE, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 201 = nqc6 nqc32_ftruncate */
	{ .sy_narg = AS(nqc32___sysctl_args), .sy_call = (sy_call_t *)nqc32___sysctl, .sy_auevent = AUE_SYSCTL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 202 = nqc32___sysctl */
	...
	{ .sy_narg = AS(nqc32_futimes_args), .sy_call = (sy_call_t *)nqc32_futimes, .sy_auevent = AUE_FUTIMES, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 206 = nqc32_futimes */
	...
	{ .sy_narg = 0, .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },		/* 220 = nqc7 nqc32___semctl */
	...
	{ .sy_narg = 0, .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },		/* 224 = nqc7 nqc32_msgctl */
	{ .sy_narg = AS(msgget_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 225 = msgget */
	{ .sy_narg = AS(nqc32_msgsnd_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 226 = nqc32_msgsnd */
	{ .sy_narg = AS(nqc32_msgrcv_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 227 = nqc32_msgrcv */
	{ .sy_narg = AS(shmat_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 228 = shmat */
	{ .sy_narg = 0, .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },		/* 229 = nqc7 nqc32_shmctl */
	...
	{ .sy_narg = AS(nqc32_clock_gettime_args), .sy_call = (sy_call_t *)nqc32_clock_gettime, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 232 = nqc32_clock_gettime */
	{ .sy_narg = AS(nqc32_clock_settime_args), .sy_call = (sy_call_t *)nqc32_clock_settime, .sy_auevent = AUE_CLOCK_SETTIME, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 233 = nqc32_clock_settime */
	{ .sy_narg = AS(nqc32_clock_getres_args), .sy_call = (sy_call_t *)nqc32_clock_getres, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 234 = nqc32_clock_getres */
	{ .sy_narg = AS(nqc32_ktimer_create_args), .sy_call = (sy_call_t *)nqc32_ktimer_create, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 235 = nqc32_ktimer_create */
	...
	{ .sy_narg = AS(nqc32_ktimer_settime_args), .sy_call = (sy_call_t *)nqc32_ktimer_settime, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 237 = nqc32_ktimer_settime */
	{ .sy_narg = AS(nqc32_ktimer_gettime_args), .sy_call = (sy_call_t *)nqc32_ktimer_gettime, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 238 = nqc32_ktimer_gettime */
	...
	{ .sy_narg = AS(nqc32_nanosleep_args), .sy_call = (sy_call_t *)nqc32_nanosleep, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 240 = nqc32_nanosleep */
	...
	{ .sy_narg = AS(nqc32_ffclock_setestimate_args), .sy_call = (sy_call_t *)nqc32_ffclock_setestimate, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 242 = nqc32_ffclock_setestimate */
	{ .sy_narg = AS(nqc32_ffclock_getestimate_args), .sy_call = (sy_call_t *)nqc32_ffclock_getestimate, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 243 = nqc32_ffclock_getestimate */
	{ .sy_narg = AS(nqc32_clock_nanosleep_args), .sy_call = (sy_call_t *)nqc32_clock_nanosleep, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 244 = nqc32_clock_nanosleep */
	...
	{ .sy_narg = AS(nqc32_clock_getcpuclockid2_args), .sy_call = (sy_call_t *)nqc32_clock_getcpuclockid2, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 247 = nqc32_clock_getcpuclockid2 */
	...
	{ .sy_narg = AS(nqc32_aio_read_args), .sy_call = (sy_call_t *)nqc32_aio_read, .sy_auevent = AUE_AIO_READ, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 255 = nqc32_aio_read */
	{ .sy_narg = AS(nqc32_aio_write_args), .sy_call = (sy_call_t *)nqc32_aio_write, .sy_auevent = AUE_AIO_WRITE, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 256 = nqc32_aio_write */
	{ .sy_narg = AS(nqc32_lio_listio_args), .sy_call = (sy_call_t *)nqc32_lio_listio, .sy_auevent = AUE_LIO_LISTIO, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 257 = nqc32_lio_listio */
	...
	{ compat11(AS(nqc11_getdents_args),getdents), .sy_auevent = AUE_O_GETDENTS, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 272 = nqc11 getdents */
	...
	{ .sy_narg = AS(nqc32_lutimes_args), .sy_call = (sy_call_t *)nqc32_lutimes, .sy_auevent = AUE_LUTIMES, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 276 = nqc32_lutimes */
	{ .sy_narg = 0, .sy_call = (sy_call_t *)nosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },			/* 277 = obsolete netbsd_msync */
	{ compat11(AS(nqc11_nqc32_nstat_args),nqc32_nstat), .sy_auevent = AUE_STAT, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 278 = nqc11 nqc32_nstat */
	{ compat11(AS(nqc11_nqc32_nfstat_args),nqc32_nfstat), .sy_auevent = AUE_FSTAT, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 279 = nqc11 nqc32_nfstat */
	{ compat11(AS(nqc11_nqc32_nlstat_args),nqc32_nlstat), .sy_auevent = AUE_LSTAT, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 280 = nqc11 nqc32_nlstat */
	...
	{ .sy_narg = AS(nqc32_preadv_args), .sy_call = (sy_call_t *)nqc32_preadv, .sy_auevent = AUE_PREADV, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 289 = nqc32_preadv */
	{ .sy_narg = AS(nqc32_pwritev_args), .sy_call = (sy_call_t *)nqc32_pwritev, .sy_auevent = AUE_PWRITEV, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 290 = nqc32_pwritev */
	...
	{ compat4(AS(nqc4_nqc32_fhstatfs_args),nqc32_fhstatfs), .sy_auevent = AUE_FHSTATFS, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 297 = nqc4 nqc32_fhstatfs */
	{ .sy_narg = AS(fhopen_args), .sy_call = (sy_call_t *)sys_fhopen, .sy_auevent = AUE_FHOPEN, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 298 = fhopen */
	{ compat11(AS(nqc11_nqc32_fhstat_args),nqc32_fhstat), .sy_auevent = AUE_FHSTAT, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 299 = nqc11 nqc32_fhstat */
	{ .sy_narg = AS(modnext_args), .sy_call = (sy_call_t *)sys_modnext, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 300 = modnext */
	{ .sy_narg = AS(nqc32_modstat_args), .sy_call = (sy_call_t *)nqc32_modstat, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 301 = nqc32_modstat */
	...
	{ .sy_narg = AS(nqc32_kldstat_args), .sy_call = (sy_call_t *)nqc32_kldstat, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 308 = nqc32_kldstat */
	...
	{ .sy_narg = AS(nqc32_aio_return_args), .sy_call = (sy_call_t *)nqc32_aio_return, .sy_auevent = AUE_AIO_RETURN, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 314 = nqc32_aio_return */
	{ .sy_narg = AS(nqc32_aio_suspend_args), .sy_call = (sy_call_t *)nqc32_aio_suspend, .sy_auevent = AUE_AIO_SUSPEND, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 315 = nqc32_aio_suspend */
	...
	{ .sy_narg = AS(nqc32_aio_error_args), .sy_call = (sy_call_t *)nqc32_aio_error, .sy_auevent = AUE_AIO_ERROR, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 317 = nqc32_aio_error */
	{ compat6(AS(nqc6_nqc32_aio_read_args),nqc32_aio_read), .sy_auevent = AUE_AIO_READ, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 318 = nqc6 nqc32_aio_read */
	{ compat6(AS(nqc6_nqc32_aio_write_args),nqc32_aio_write), .sy_auevent = AUE_AIO_WRITE, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 319 = nqc6 nqc32_aio_write */
	{ compat6(AS(nqc6_nqc32_lio_listio_args),nqc32_lio_listio), .sy_auevent = AUE_LIO_LISTIO, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 320 = nqc6 nqc32_lio_listio */
	...
	{ .sy_narg = AS(nqc32_sched_rr_get_interval_args), .sy_call = (sy_call_t *)nqc32_sched_rr_get_interval, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 334 = nqc32_sched_rr_get_interval */
	...
	{ compat4(AS(nqc4_nqc32_sendfile_args),nqc32_sendfile), .sy_auevent = AUE_SENDFILE, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 336 = nqc4 nqc32_sendfile */
	{ .sy_narg = 0, .sy_call = (sy_call_t *)nosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },			/* 337 = kldsym */
	{ .sy_narg = AS(nqc32_jail_args), .sy_call = (sy_call_t *)nqc32_jail, .sy_auevent = AUE_JAIL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 338 = nqc32_jail */
	...
	{ compat4(AS(nqc4_nqc32_sigaction_args),nqc32_sigaction), .sy_auevent = AUE_SIGACTION, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 342 = nqc4 nqc32_sigaction */
	...
	{ compat4(AS(nqc4_nqc32_sigreturn_args),nqc32_sigreturn), .sy_auevent = AUE_SIGRETURN, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 344 = nqc4 nqc32_sigreturn */
	{ .sy_narg = AS(nqc32_sigtimedwait_args), .sy_call = (sy_call_t *)nqc32_sigtimedwait, .sy_auevent = AUE_SIGWAIT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 345 = nqc32_sigtimedwait */
	{ .sy_narg = AS(nqc32_sigwaitinfo_args), .sy_call = (sy_call_t *)nqc32_sigwaitinfo, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 346 = nqc32_sigwaitinfo */
	...
	{ .sy_narg = AS(nqc32_aio_waitcomplete_args), .sy_call = (sy_call_t *)nqc32_aio_waitcomplete, .sy_auevent = AUE_AIO_WAITCOMPLETE, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 359 = nqc32_aio_waitcomplete */
	...
	{ compat11(AS(nqc11_nqc32_kevent_args),nqc32_kevent), .sy_auevent = AUE_KEVENT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 363 = nqc11 nqc32_kevent */
	...
	{ .sy_narg = AS(nqc32_nmount_args), .sy_call = (sy_call_t *)nqc32_nmount, .sy_auevent = AUE_NMOUNT, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 378 = nqc32_nmount */
	...
	{ .sy_narg = AS(nqc32_sendfile_args), .sy_call = (sy_call_t *)nqc32_sendfile, .sy_auevent = AUE_SENDFILE, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 393 = nqc32_sendfile */
	{ .sy_narg = 0, .sy_call = (sy_call_t *)nosys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },			/* 394 = mac_syscall */
	{ compat11(AS(nqc11_nqc32_getfsstat_args),nqc32_getfsstat), .sy_auevent = AUE_GETFSSTAT, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 395 = nqc11 nqc32_getfsstat */
	{ compat11(AS(nqc11_statfs_args),statfs), .sy_auevent = AUE_STATFS, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 396 = nqc11 statfs */
	{ compat11(AS(nqc11_fstatfs_args),fstatfs), .sy_auevent = AUE_FSTATFS, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 397 = nqc11 fstatfs */
	{ compat11(AS(nqc11_fhstatfs_args),fhstatfs), .sy_auevent = AUE_FHSTATFS, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 398 = nqc11 fhstatfs */
	...
	{ .sy_narg = AS(nqc32_ksem_init_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 404 = nqc32_ksem_init */
	{ .sy_narg = AS(nqc32_ksem_open_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 405 = nqc32_ksem_open */
	...
	{ .sy_narg = AS(nqc32_sigaction_args), .sy_call = (sy_call_t *)nqc32_sigaction, .sy_auevent = AUE_SIGACTION, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 416 = nqc32_sigaction */
	{ .sy_narg = AS(nqc32_sigreturn_args), .sy_call = (sy_call_t *)nqc32_sigreturn, .sy_auevent = AUE_SIGRETURN, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 417 = nqc32_sigreturn */
	...
	{ .sy_narg = AS(nqc32_getcontext_args), .sy_call = (sy_call_t *)nqc32_getcontext, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 421 = nqc32_getcontext */
	{ .sy_narg = AS(nqc32_setcontext_args), .sy_call = (sy_call_t *)nqc32_setcontext, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 422 = nqc32_setcontext */
	{ .sy_narg = AS(nqc32_swapcontext_args), .sy_call = (sy_call_t *)nqc32_swapcontext, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 423 = nqc32_swapcontext */
	{ compat13(AS(nqc13_swapoff_args),swapoff), .sy_auevent = AUE_SWAPOFF, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 424 = nqc13 swapoff */
	...
	{ compat10(AS(nqc10_nqc32__umtx_lock_args),nqc32__umtx_lock), .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 434 = nqc10 nqc32__umtx_lock */
	{ compat10(AS(nqc10_nqc32__umtx_unlock_args),nqc32__umtx_unlock), .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 435 = nqc10 nqc32__umtx_unlock */
	...
	{ .sy_narg = AS(nqc32_ksem_timedwait_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 441 = nqc32_ksem_timedwait */
	{ .sy_narg = AS(nqc32_thr_suspend_args), .sy_call = (sy_call_t *)nqc32_thr_suspend, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 442 = nqc32_thr_suspend */
	...
	{ .sy_narg = AS(nqc32__umtx_op_args), .sy_call = (sy_call_t *)nqc32__umtx_op, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 454 = nqc32__umtx_op */
	{ .sy_narg = AS(nqc32_thr_new_args), .sy_call = (sy_call_t *)nqc32_thr_new, .sy_auevent = AUE_THR_NEW, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 455 = nqc32_thr_new */
	{ .sy_narg = AS(nqc32_sigqueue_args), .sy_call = (sy_call_t *)nqc32_sigqueue, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 456 = nqc32_sigqueue */
	{ .sy_narg = AS(nqc32_kmq_open_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 457 = nqc32_kmq_open */
	{ .sy_narg = AS(nqc32_kmq_setattr_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_ABSENT },	/* 458 = nqc32_kmq_setattr */
	{ .sy_narg = AS(nqc32_kmq_timedreceive_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_ABSENT },	/* 459 = nqc32_kmq_timedreceive */
	{ .sy_narg = AS(nqc32_kmq_timedsend_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_ABSENT },	/* 460 = nqc32_kmq_timedsend */
	{ .sy_narg = AS(nqc32_kmq_notify_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_ABSENT },	/* 461 = nqc32_kmq_notify */
	...
	{ .sy_narg = AS(nqc32_abort2_args), .sy_call = (sy_call_t *)nqc32_abort2, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 463 = nqc32_abort2 */
	...
	{ .sy_narg = AS(nqc32_aio_fsync_args), .sy_call = (sy_call_t *)nqc32_aio_fsync, .sy_auevent = AUE_AIO_FSYNC, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 465 = nqc32_aio_fsync */
	...
	{ .sy_narg = AS(nqc32_pread_args), .sy_call = (sy_call_t *)nqc32_pread, .sy_auevent = AUE_PREAD, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 475 = nqc32_pread */
	{ .sy_narg = AS(nqc32_pwrite_args), .sy_call = (sy_call_t *)nqc32_pwrite, .sy_auevent = AUE_PWRITE, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 476 = nqc32_pwrite */
	{ .sy_narg = AS(nqc32_mmap_args), .sy_call = (sy_call_t *)nqc32_mmap, .sy_auevent = AUE_MMAP, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 477 = nqc32_mmap */
	{ .sy_narg = AS(nqc32_lseek_args), .sy_call = (sy_call_t *)nqc32_lseek, .sy_auevent = AUE_LSEEK, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 478 = nqc32_lseek */
	{ .sy_narg = AS(nqc32_truncate_args), .sy_call = (sy_call_t *)nqc32_truncate, .sy_auevent = AUE_TRUNCATE, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 479 = nqc32_truncate */
	{ .sy_narg = AS(nqc32_ftruncate_args), .sy_call = (sy_call_t *)nqc32_ftruncate, .sy_auevent = AUE_FTRUNCATE, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 480 = nqc32_ftruncate */
	...
	{ compat12(AS(nqc12_shm_open_args),shm_open), .sy_auevent = AUE_SHMOPEN, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 482 = nqc12 shm_open */
	...
	{ .sy_narg = AS(nqc32_cpuset_setid_args), .sy_call = (sy_call_t *)nqc32_cpuset_setid, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 485 = nqc32_cpuset_setid */
	{ .sy_narg = AS(nqc32_cpuset_getid_args), .sy_call = (sy_call_t *)nqc32_cpuset_getid, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 486 = nqc32_cpuset_getid */
	{ .sy_narg = AS(nqc32_cpuset_getaffinity_args), .sy_call = (sy_call_t *)nqc32_cpuset_getaffinity, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 487 = nqc32_cpuset_getaffinity */
	{ .sy_narg = AS(nqc32_cpuset_setaffinity_args), .sy_call = (sy_call_t *)nqc32_cpuset_setaffinity, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 488 = nqc32_cpuset_setaffinity */
	...
	{ .sy_narg = AS(nqc32_fexecve_args), .sy_call = (sy_call_t *)nqc32_fexecve, .sy_auevent = AUE_FEXECVE, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 492 = nqc32_fexecve */
	{ compat11(AS(nqc11_nqc32_fstatat_args),nqc32_fstatat), .sy_auevent = AUE_FSTATAT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 493 = nqc11 nqc32_fstatat */
	{ .sy_narg = AS(nqc32_futimesat_args), .sy_call = (sy_call_t *)nqc32_futimesat, .sy_auevent = AUE_FUTIMESAT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 494 = nqc32_futimesat */
	...
	{ compat11(AS(nqc11_mknodat_args),mknodat), .sy_auevent = AUE_MKNODAT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 498 = nqc11 mknodat */
	...
	{ .sy_narg = AS(nqc32_jail_get_args), .sy_call = (sy_call_t *)nqc32_jail_get, .sy_auevent = AUE_JAIL_GET, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 506 = nqc32_jail_get */
	{ .sy_narg = AS(nqc32_jail_set_args), .sy_call = (sy_call_t *)nqc32_jail_set, .sy_auevent = AUE_JAIL_SET, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 507 = nqc32_jail_set */
	...
	{ compat12(AS(nqc12_closefrom_args),closefrom), .sy_auevent = AUE_CLOSEFROM, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 509 = nqc12 closefrom */
	{ .sy_narg = AS(nqc32___semctl_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 510 = nqc32___semctl */
	{ .sy_narg = AS(nqc32_msgctl_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 511 = nqc32_msgctl */
	{ .sy_narg = AS(nqc32_shmctl_args), .sy_call = (sy_call_t *)lkmressys, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_ABSENT },	/* 512 = nqc32_shmctl */
	...
	{ .sy_narg = AS(nqc32_pselect_args), .sy_call = (sy_call_t *)nqc32_pselect, .sy_auevent = AUE_SELECT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 522 = nqc32_pselect */
	...
	{ .sy_narg = AS(nqc32_posix_fallocate_args), .sy_call = (sy_call_t *)nqc32_posix_fallocate, .sy_auevent = AUE_POSIX_FALLOCATE, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 530 = nqc32_posix_fallocate */
	{ .sy_narg = AS(nqc32_posix_fadvise_args), .sy_call = (sy_call_t *)nqc32_posix_fadvise, .sy_auevent = AUE_POSIX_FADVISE, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 531 = nqc32_posix_fadvise */
	{ .sy_narg = AS(nqc32_wait6_args), .sy_call = (sy_call_t *)nqc32_wait6, .sy_auevent = AUE_WAIT6, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 532 = nqc32_wait6 */
	...
	{ .sy_narg = AS(nqc32_cap_ioctls_limit_args), .sy_call = (sy_call_t *)nqc32_cap_ioctls_limit, .sy_auevent = AUE_CAP_IOCTLS_LIMIT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 534 = nqc32_cap_ioctls_limit */
	{ .sy_narg = AS(nqc32_cap_ioctls_get_args), .sy_call = (sy_call_t *)nqc32_cap_ioctls_get, .sy_auevent = AUE_CAP_IOCTLS_GET, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 535 = nqc32_cap_ioctls_get */
	...
	{ .sy_narg = AS(nqc32_aio_mlock_args), .sy_call = (sy_call_t *)nqc32_aio_mlock, .sy_auevent = AUE_AIO_MLOCK, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 543 = nqc32_aio_mlock */
	{ .sy_narg = AS(nqc32_procctl_args), .sy_call = (sy_call_t *)nqc32_procctl, .sy_auevent = AUE_PROCCTL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 544 = nqc32_procctl */
	{ .sy_narg = AS(nqc32_ppoll_args), .sy_call = (sy_call_t *)nqc32_ppoll, .sy_auevent = AUE_POLL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 545 = nqc32_ppoll */
	{ .sy_narg = AS(nqc32_futimens_args), .sy_call = (sy_call_t *)nqc32_futimens, .sy_auevent = AUE_FUTIMES, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 546 = nqc32_futimens */
	{ .sy_narg = AS(nqc32_utimensat_args), .sy_call = (sy_call_t *)nqc32_utimensat, .sy_auevent = AUE_FUTIMESAT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 547 = nqc32_utimensat */
	...
	{ .sy_narg = AS(nqc32_fstat_args), .sy_call = (sy_call_t *)nqc32_fstat, .sy_auevent = AUE_FSTAT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 551 = nqc32_fstat */
	{ .sy_narg = AS(nqc32_fstatat_args), .sy_call = (sy_call_t *)nqc32_fstatat, .sy_auevent = AUE_FSTATAT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 552 = nqc32_fstatat */
	{ .sy_narg = AS(nqc32_fhstat_args), .sy_call = (sy_call_t *)nqc32_fhstat, .sy_auevent = AUE_FHSTAT, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 553 = nqc32_fhstat */
	...
	{ .sy_narg = AS(nqc32_getfsstat_args), .sy_call = (sy_call_t *)nqc32_getfsstat, .sy_auevent = AUE_GETFSSTAT, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 557 = nqc32_getfsstat */
	...
	{ .sy_narg = AS(nqc32_mknodat_args), .sy_call = (sy_call_t *)nqc32_mknodat, .sy_auevent = AUE_MKNODAT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 559 = nqc32_mknodat */
	{ .sy_narg = AS(nqc32_kevent_args), .sy_call = (sy_call_t *)nqc32_kevent, .sy_auevent = AUE_KEVENT, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 560 = nqc32_kevent */
	{ .sy_narg = AS(nqc32_cpuset_getdomain_args), .sy_call = (sy_call_t *)nqc32_cpuset_getdomain, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 561 = nqc32_cpuset_getdomain */
	{ .sy_narg = AS(nqc32_cpuset_setdomain_args), .sy_call = (sy_call_t *)nqc32_cpuset_setdomain, .sy_auevent = AUE_NULL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 562 = nqc32_cpuset_setdomain */
	...
	{ .sy_narg = AS(nqc32___sysctlbyname_args), .sy_call = (sy_call_t *)nqc32___sysctlbyname, .sy_auevent = AUE_SYSCTL, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 570 = nqc32___sysctlbyname */
	...
	{ .sy_narg = AS(nqc32_aio_writev_args), .sy_call = (sy_call_t *)nqc32_aio_writev, .sy_auevent = AUE_AIO_WRITEV, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 578 = nqc32_aio_writev */
	{ .sy_narg = AS(nqc32_aio_readv_args), .sy_call = (sy_call_t *)nqc32_aio_readv, .sy_auevent = AUE_AIO_READV, .sy_flags = SYF_CAPENABLED, .sy_thrcnt = SY_THR_STATIC },	/* 579 = nqc32_aio_readv */
