//===-- RegisterContextNQCKernel_arm64.cpp ----------------------------===//
//
...
RegisterContextNQCKernel_arm64::RegisterContextNQCKernel_arm64(
...
bool RegisterContextNQCKernel_arm64::ReadGPR() { return true; }

bool RegisterContextNQCKernel_arm64::ReadFPR() { return true; }

bool RegisterContextNQCKernel_arm64::WriteGPR() {
  assert(0);
  return false;
}

bool RegisterContextNQCKernel_arm64::WriteFPR() {
  assert(0);
  return false;
}

bool RegisterContextNQCKernel_arm64::ReadRegister(
...
bool RegisterContextNQCKernel_arm64::WriteRegister(
