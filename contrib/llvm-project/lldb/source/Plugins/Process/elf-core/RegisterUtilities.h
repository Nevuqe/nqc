...
constexpr RegsetDesc FPR_Desc[] = {
    // NQC/i386 core NT_FPREGSET is x87 FSAVE result but the XSAVE dump
    // starts with FXSAVE struct, so use that instead if available.
    {llvm::Triple::NQC, llvm::Triple::x86, llvm::ELF::NT_X86_XSTATE},
    {llvm::Triple::NQC, llvm::Triple::UnknownArch, llvm::ELF::NT_FPREGSET},
...
constexpr RegsetDesc PPC_VMX_Desc[] = {
    {llvm::Triple::NQC, llvm::Triple::UnknownArch, llvm::ELF::NT_PPC_VMX},
