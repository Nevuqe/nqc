...
#define SI_LINUX_NOT_NQC 1
#else
#define SI_LINUX_NOT_NQC 0
#endif
...
#define SANITIZER_INTERCEPT_BCMP \
  SANITIZER_INTERCEPT_MEMCMP &&  \
      ((SI_POSIX && _GNU_SOURCE) || SI_NETBSD || SI_NQC)
...
#define SANITIZER_INTERCEPT_MEMRCHR (SI_NQC || SI_LINUX || SI_NETBSD)
...
#define SANITIZER_INTERCEPT_PREADV \
  (SI_NQC || SI_NETBSD || SI_LINUX_NOT_ANDROID)
...
#define SANITIZER_INTERCEPT_PRINTF_L (SI_NQC || SI_NETBSD)
...
#define SANITIZER_INTERCEPT_GETPWNAM_R_AND_FRIENDS \
  (SI_NQC || SI_NETBSD || SI_MAC || SI_LINUX_NOT_ANDROID || SI_SOLARIS)
#define SANITIZER_INTERCEPT_GETPWENT \
  (SI_NQC || SI_NETBSD || SI_MAC || SI_LINUX_NOT_ANDROID || SI_SOLARIS)
#define SANITIZER_INTERCEPT_FGETGRENT_R (SI_GLIBC || SI_SOLARIS)
#define SANITIZER_INTERCEPT_FGETPWENT SI_LINUX_NOT_ANDROID || SI_SOLARIS
#define SANITIZER_INTERCEPT_GETPWENT_R \
  (SI_NQC || SI_NETBSD || SI_GLIBC || SI_SOLARIS)
#define SANITIZER_INTERCEPT_FGETPWENT_R (SI_NQC || SI_GLIBC || SI_SOLARIS)
#define SANITIZER_INTERCEPT_SETPWENT \
  (SI_MAC || SI_LINUX_NOT_ANDROID || SI_SOLARIS)
#define SANITIZER_INTERCEPT_CLOCK_GETTIME \
  (SI_NQC || SI_NETBSD || SI_LINUX || SI_SOLARIS)
#define SANITIZER_INTERCEPT_CLOCK_GETCPUCLOCKID \
  (SI_LINUX || SI_NQC || SI_NETBSD)
...
#define SANITIZER_INTERCEPT_GETHOSTBYNAME_R \
  (SI_NQC || SI_LINUX || SI_SOLARIS)
#define SANITIZER_INTERCEPT_GETHOSTBYNAME2_R \
  (SI_NQC || SI_LINUX_NOT_ANDROID)
#define SANITIZER_INTERCEPT_GETHOSTBYADDR_R \
  (SI_NQC || SI_LINUX_NOT_ANDROID || SI_SOLARIS)
#define SANITIZER_INTERCEPT_GETHOSTENT_R (SI_NQC || SI_GLIBC || SI_SOLARIS)
#define SANITIZER_INTERCEPT_GETSOCKOPT SI_POSIX
#define SANITIZER_INTERCEPT_ACCEPT SI_POSIX
#define SANITIZER_INTERCEPT_ACCEPT4 \
  (SI_LINUX_NOT_ANDROID || SI_NETBSD || SI_NQC)
...
#define SANITIZER_INTERCEPT_STATFS \
  (SI_NQC || SI_MAC || SI_LINUX_NOT_ANDROID || SI_SOLARIS)
...
#define SANITIZER_INTERCEPT_ETHER_HOST \
  (SI_NQC || SI_MAC || SI_LINUX_NOT_ANDROID)
#define SANITIZER_INTERCEPT_ETHER_R (SI_NQC || SI_LINUX_NOT_ANDROID)
#define SANITIZER_INTERCEPT_SHMCTL                                       \
  (((SI_NQC || SI_LINUX_NOT_ANDROID) && SANITIZER_WORDSIZE == 64) || \
...
#define SANITIZER_INTERCEPT_THR_EXIT SI_NQC
...
#define SANITIZER_INTERCEPT_LGAMMA_R (SI_NQC || SI_LINUX || SI_SOLARIS)
...
#define SANITIZER_INTERCEPT__EXIT \
  (SI_LINUX || SI_NQC || SI_NETBSD || SI_MAC || SI_SOLARIS)
...
#define SANITIZER_INTERCEPT_GETIFADDRS \
  (SI_NQC || SI_NETBSD || SI_LINUX_NOT_ANDROID || SI_MAC || SI_SOLARIS)
...
#define SANITIZER_INTERCEPT_FTIME (!SI_NQC && !SI_NETBSD && SI_POSIX)
...
#define SANITIZER_INTERCEPT_SEM \
  (SI_LINUX || SI_NQC || SI_NETBSD || SI_SOLARIS)
#define SANITIZER_INTERCEPT_PTHREAD_SETCANCEL SI_POSIX
#define SANITIZER_INTERCEPT_MINCORE \
  (SI_LINUX || SI_NETBSD || SI_NQC || SI_SOLARIS)
#define SANITIZER_INTERCEPT_PROCESS_VM_READV SI_LINUX
#define SANITIZER_INTERCEPT_CTERMID \
  (SI_LINUX || SI_MAC || SI_NQC || SI_NETBSD || SI_SOLARIS)
#define SANITIZER_INTERCEPT_CTERMID_R (SI_MAC || SI_NQC || SI_SOLARIS)

#define SANITIZER_INTERCEPTOR_HOOKS \
  (SI_LINUX || SI_MAC || SI_WINDOWS || SI_NQC || SI_NETBSD || SI_SOLARIS)
...
#define SANITIZER_INTERCEPT_STAT                                        \
  (SI_NQC || SI_MAC || SI_ANDROID || SI_NETBSD || SI_SOLARIS ||     \
   SI_STAT_LINUX)
#define SANITIZER_INTERCEPT_STAT64 SI_STAT_LINUX && SANITIZER_HAS_STAT64
#define SANITIZER_INTERCEPT_LSTAT (SI_NETBSD || SI_NQC || SI_STAT_LINUX)
...
#define SANITIZER_INTERCEPT_UTMP \
  (SI_POSIX && !SI_MAC && !SI_NQC && !SI_NETBSD)
#define SANITIZER_INTERCEPT_UTMPX \
  (SI_LINUX_NOT_ANDROID || SI_MAC || SI_NQC || SI_NETBSD)
...
#define SANITIZER_INTERCEPT_MEMALIGN (!SI_NQC && !SI_MAC && !SI_NETBSD)
...
#define SANITIZER_INTERCEPT_ACCT (SI_NETBSD || SI_NQC)
...
#define SANITIZER_INTERCEPT_ACCESS (SI_NETBSD || SI_NQC)
#define SANITIZER_INTERCEPT_FACCESSAT (SI_NETBSD || SI_NQC)
#define SANITIZER_INTERCEPT_GETGROUPLIST \
  (SI_NETBSD || SI_NQC || SI_LINUX)
#define SANITIZER_INTERCEPT_STRLCPY \
  (SI_NETBSD || SI_NQC || SI_MAC || SI_ANDROID)
...
#define SANITIZER_INTERCEPT_DEVNAME (SI_NETBSD || SI_NQC)
#define SANITIZER_INTERCEPT_DEVNAME_R (SI_NETBSD || SI_NQC)
#define SANITIZER_INTERCEPT_FGETLN (SI_NETBSD || SI_NQC)
#define SANITIZER_INTERCEPT_STRMODE (SI_NETBSD || SI_NQC)
#define SANITIZER_INTERCEPT_TTYENT (SI_NETBSD || SI_NQC)
#define SANITIZER_INTERCEPT_TTYENTPATH SI_NETBSD
#define SANITIZER_INTERCEPT_PROTOENT (SI_LINUX || SI_NETBSD || SI_NQC)
#define SANITIZER_INTERCEPT_PROTOENT_R SI_GLIBC
#define SANITIZER_INTERCEPT_NETENT (SI_LINUX || SI_NETBSD || SI_NQC)
#define SANITIZER_INTERCEPT_SETVBUF \
  (SI_NETBSD || SI_NQC || SI_LINUX || SI_MAC)
#define SANITIZER_INTERCEPT_GETMNTINFO (SI_NETBSD || SI_NQC || SI_MAC)
#define SANITIZER_INTERCEPT_MI_VECTOR_HASH SI_NETBSD
#define SANITIZER_INTERCEPT_GETVFSSTAT SI_NETBSD
#define SANITIZER_INTERCEPT_REGEX (SI_NETBSD || SI_NQC || SI_LINUX)
#define SANITIZER_INTERCEPT_REGEXSUB SI_NETBSD
#define SANITIZER_INTERCEPT_FTS (SI_NETBSD || SI_NQC)
#define SANITIZER_INTERCEPT_SYSCTL (SI_NETBSD || SI_NQC || SI_MAC)
#define SANITIZER_INTERCEPT_ASYSCTL SI_NETBSD
#define SANITIZER_INTERCEPT_SYSCTLGETMIBINFO SI_NETBSD
#define SANITIZER_INTERCEPT_NL_LANGINFO (SI_NETBSD || SI_NQC || SI_MAC)
#define SANITIZER_INTERCEPT_MODCTL SI_NETBSD
#define SANITIZER_INTERCEPT_CAPSICUM SI_NQC
#define SANITIZER_INTERCEPT_STRTONUM (SI_NETBSD || SI_NQC)
#define SANITIZER_INTERCEPT_FPARSELN (SI_NETBSD || SI_NQC)
...
#define SANITIZER_INTERCEPT_MD5 (SI_NETBSD || SI_NQC)
#define SANITIZER_INTERCEPT_FSEEK (SI_NETBSD || SI_NQC)
#define SANITIZER_INTERCEPT_MD2 SI_NETBSD
#define SANITIZER_INTERCEPT_SHA2 (SI_NETBSD || SI_NQC)
#define SANITIZER_INTERCEPT_CDB SI_NETBSD
#define SANITIZER_INTERCEPT_VIS (SI_NETBSD || SI_NQC)
#define SANITIZER_INTERCEPT_POPEN SI_POSIX
#define SANITIZER_INTERCEPT_POPENVE SI_NETBSD
#define SANITIZER_INTERCEPT_PCLOSE SI_POSIX
#define SANITIZER_INTERCEPT_FUNOPEN (SI_NETBSD || SI_NQC)
#define SANITIZER_INTERCEPT_FUNOPEN2 SI_NETBSD
#define SANITIZER_INTERCEPT_GETFSENT (SI_NQC || SI_NETBSD || SI_MAC)
#define SANITIZER_INTERCEPT_ARC4RANDOM (SI_NQC || SI_NETBSD || SI_MAC)
#define SANITIZER_INTERCEPT_FDEVNAME SI_NQC
#define SANITIZER_INTERCEPT_GETUSERSHELL (SI_POSIX && !SI_ANDROID)
#define SANITIZER_INTERCEPT_SL_INIT (SI_NQC || SI_NETBSD)
#define SANITIZER_INTERCEPT_CRYPT (SI_POSIX && !SI_ANDROID)
#define SANITIZER_INTERCEPT_CRYPT_R (SI_LINUX && !SI_ANDROID)

#define SANITIZER_INTERCEPT_GETRANDOM \
  ((SI_LINUX && __GLIBC_PREREQ(2, 25)) || SI_NQC)
#define SANITIZER_INTERCEPT___CXA_ATEXIT SI_NETBSD
#define SANITIZER_INTERCEPT_ATEXIT SI_NETBSD
#define SANITIZER_INTERCEPT_PTHREAD_ATFORK SI_NETBSD
#define SANITIZER_INTERCEPT_GETENTROPY SI_NQC
...
#define SANITIZER_INTERCEPT_UNAME (SI_POSIX && !SI_NQC)
#define SANITIZER_INTERCEPT___XUNAME SI_NQC
#define SANITIZER_INTERCEPT_FLOPEN SI_NQC
#define SANITIZER_INTERCEPT_PROCCTL SI_NQC
