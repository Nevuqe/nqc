...
#define ECase(X) IO.enumCase(Value, #X, ELF::X)
  ...
  ECase(NT_NQC_PROCSTAT_VMMAP);
  ECase(NT_NQC_PROCSTAT_GROUPS);
  ECase(NT_NQC_PROCSTAT_UMASK);
  ECase(NT_NQC_PROCSTAT_RLIMIT);
  ECase(NT_NQC_PROCSTAT_OSREL);
  ECase(NT_NQC_PROCSTAT_PSSTRINGS);
  ECase(NT_NQC_PROCSTAT_AUXV);
