...
enum {
  ...
  NT_NQC_FCTL_STKGAP_DISABLE = 0x00000004,
  NT_NQC_FCTL_WXNEEDED = 0x00000008,
  NT_NQC_FCTL_LA48 = 0x00000010,
...
enum {
  ...
  NT_NQC_PROCSTAT_FILES = 9,
  NT_NQC_PROCSTAT_VMMAP = 10,
  NT_NQC_PROCSTAT_GROUPS = 11,
  NT_NQC_PROCSTAT_UMASK = 12,
  NT_NQC_PROCSTAT_RLIMIT = 13,
  NT_NQC_PROCSTAT_OSREL = 14,
  NT_NQC_PROCSTAT_PSSTRINGS = 15,
  NT_NQC_PROCSTAT_AUXV = 16,
};
